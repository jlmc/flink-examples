# Exemplo de Funções de Janela (Window Functions)

Este exemplo demonstra como usar `AggregateFunction` no Flink.

## Cenário
Usamos uma `AggregateFunction` para calcular a média de temperatura de forma incremental.
