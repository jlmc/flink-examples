...
class AggregateFunctionExampleTest {
    ...
    @Test
    void shouldComputeAveragePerWindow() throws Exception {
        ...
        AggregateFunctionExample.definePipeline(stream)
                .addSink(new CollectSink<>());

        env.execute("AggregateFunctionExampleTest");

        List<Double> results = CollectSink.values();
        assertThat(results).hasSize(2);
        assertThat(results).containsExactlyInAnyOrder(25.0, 100.0);
    }
}
