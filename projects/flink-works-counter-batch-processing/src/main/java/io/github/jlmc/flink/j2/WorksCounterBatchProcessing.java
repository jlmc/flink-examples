package io.github.jlmc.flink.j2;
...
public class WorksCounterBatchProcessing {

    public static final Logger LOGGER = LoggerFactory.getLogger(WorksCounterBatchProcessing.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ⚠️ CRITICAL: Set the execution mode to BATCH for bounded input processing
